...
for (env in env_names) {
  ...
  block2 <- grid.arrange(grobs = etf_plots[5:7], ncol = 2)
  
  # Guardar los gráficos en la lista
  all_plots[[env]] <- list(block1, block2)
}

# Mostrar los gráficos finales
# Para gauss:
grid.arrange(all_plots[["gauss"]][[1]], all_plots[["gauss"]][[2]])
# Para t:
grid.arrange(all_plots[["t"]][[1]], all_plots[["t"]][[2]])
# Para copula:
